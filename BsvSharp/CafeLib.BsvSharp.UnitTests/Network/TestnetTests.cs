...
namespace CafeLib.BsvSharp.UnitTests.Network
{
    public class TestnetTests
    {
        ...
        {
            var publicKey = new PublicKey("0x022df8750480ad5b26950b25c7ba79d3e37d75f640f8e5d9bcd5b150a0f85014da");
            ...
            Assert.Equal("muEVSGaM5JgmdsHzS37m3sKNyvjn8cZ8NZ", address.ToString());
            Assert.Equal(NetworkType.Test, publicKey.ToAddress(NetworkType.Test).NetworkType);
        }
